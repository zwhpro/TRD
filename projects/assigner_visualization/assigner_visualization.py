...
def parse_args():
    parser = argparse.ArgumentParser(
        ...
        ' results.')
    parser.add_argument('config',default=r'F:\git\mmyolo\projects\assigner_visualization\configs\yolov5_s-v61_syncbn_fast_8xb16-300e_coco_assignervisualization.py', help='config file path')
