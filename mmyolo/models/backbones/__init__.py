...
from .trd_darknet import YOLOv8CSPDarknetTRD,YOLOv8CSPDarknetHWD,YOLOv8CSPDarknetRFD,YOLOv8CSPDarknetSCDown,YOLOv8CSPDarknetADown
...
__all__ = [
    ...
    'YOLOXCSPDarknet', 'CSPNeXt', 'YOLOv7Backbone', 'PPYOLOECSPResNet','YOLOv8CSPDarknetSCDown','YOLOv8CSPDarknetADown',
